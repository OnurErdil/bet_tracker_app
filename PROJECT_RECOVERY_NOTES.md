...
GitHub repo aç.
V1_NOTES.md, V2_PLAN.md, PROJECT_RECOVERY_NOTES.md dosyalarını oku.
Terminalde çalıştır:
flutter analyze
flutter test
İlk açık iş:
...
V1’e yeni büyük özellik ekleme.
Önce hotfix ve polish tamamlanmalı.

Bunu ekleyince proje artık “başına bir şey gelirse nereden toparlarız?” sorusuna hazır olur. Kara kutu tamam, uçak zaten uçuyor ama biz yine de tedbirliyiz 😄